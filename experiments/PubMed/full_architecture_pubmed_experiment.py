...
class GraphBioNetwork(nn.Module):
    def __init__(self, num_node_features, num_classes=7,enable_monitoring=False, disable_monitoring=False,results_dir = 'pubmed_results_Gat_attention_only'):
        ...
        self.bio_layers = nn.ModuleList([
            BioLogicalNeuron(hidden_dim * 6, 1024, repair_threshold=0.95, repair_intensity=0.015, plasticity_rate=0.0015,enable_monitoring=monitoring_state,log_file=os.path.join(log_base_path,'bio_layer_cora.log'),summary_interval=5),
            BioLogicalNeuron(1024, 512, repair_threshold=0.95, repair_intensity=0.015, plasticity_rate=0.0015,enable_monitoring=monitoring_state,log_file=os.path.join(log_base_path,'bio_layer_cora.log'),summary_interval=5),
            BioLogicalNeuron(512, 256, repair_threshold=0.95, repair_intensity=0.015, plasticity_rate=0.0015,enable_monitoring=monitoring_state,log_file=os.path.join(log_base_path,'bio_layer_cora.log'),summary_interval=5),
        ])
        
        # Enhanced classifier wienable_monitoring=monitoring_state,log_file='bio_layer1.log'
...
class PUBMEDTrainer:
    def __init__(self, n_splits=10, seed=42, wandb_logging=False, enable_monitoring=False, disable_monitoring=False):
        ...
        # Load dataset
        self.dataset = Planetoid(root='/tmp/PubMed', name='PubMed')
    ...
    def train_and_evaluate(self):
        ...
        results_path = os.path.join(self.results_dir, 'pubmed_cv_results.json')
