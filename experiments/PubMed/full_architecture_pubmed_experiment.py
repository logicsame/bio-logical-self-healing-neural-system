...
class GraphBioNetwork(nn.Module):
    def __init__(self, num_node_features, num_classes=7,enable_monitoring=False, disable_monitoring=False):
        ...
        self.bio_layers = nn.ModuleList([
            BioLogicalNeuron(hidden_dim * 6, 1024, repair_threshold=0.95, repair_intensity=0.015, plasticity_rate=0.0015,enable_monitoring=monitoring_state,log_file='full_architecture_bio_layer_pubmed_1.log',summary_interval=5),
            BioLogicalNeuron(1024, 512, repair_threshold=0.95, repair_intensity=0.015, plasticity_rate=0.0015,enable_monitoring=monitoring_state,log_file='full_architecture_bio_layer_pubmed_1.log',summary_interval=5),
            BioLogicalNeuron(512, 256, repair_threshold=0.95, repair_intensity=0.015, plasticity_rate=0.0015,enable_monitoring=monitoring_state,log_file='full_architecture_bio_layer_pubmed_1.log',summary_interval=5),
        ])
