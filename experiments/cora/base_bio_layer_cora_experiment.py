...
def create_results_directory():
    results_dir = 'cora_results_base_bio_layers'
...
class GraphBioNetwork(nn.Module):
    def __init__(self, num_node_features, num_classes=7, enable_monitoring=False, disable_monitoring=False, results_dir = 'cora_results_base_bio_layers'):
        super().__init__()
