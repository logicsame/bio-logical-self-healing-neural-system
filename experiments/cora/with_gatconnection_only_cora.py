...
class GraphBioNetwork(nn.Module):
    def __init__(self, num_node_features, num_classes=7,enable_monitoring=False, disable_monitoring=False,results_dir = 'cora_results_witout_bio_layers'):
        super().__init__()
        ...
        self.bio_layers = nn.ModuleList([
            BioLogicalNeuron(hidden_dim * 6, 1024, repair_threshold=0.95, repair_intensity=0.015, plasticity_rate=0.0015,summary_interval=5,enable_monitoring=monitoring_state,log_file=os.path.join(log_base_path, 'bio_layer1')),
            BioLogicalNeuron(1024, 512, repair_threshold=0.95, repair_intensity=0.015, plasticity_rate=0.0015,summary_interval=5,enable_monitoring=monitoring_state,log_file=os.path.join(log_base_path, 'bio_layer2')),
            BioLogicalNeuron(512, 256, repair_threshold=0.95, repair_intensity=0.015, plasticity_rate=0.0015,summary_interval=5,enable_monitoring=monitoring_state,log_file=os.path.join(log_base_path, 'bio_layer3')),
        ])
...
class CoraCVTrainer:
    ...
    def train_and_evaluate(self):
        ...
        results_path = os.path.join(self.results_dir, 'without_bio_layer_cora_cv_results.json')
