...
class ModernNetwork(nn.Module):
    """Enhanced Network with improved architecture"""
...
class CIFAR10Trainer:
    def __init__(self, n_splits=2, seed=42, wandb_logging=False):
    ...
    def train_and_evaluate(self):
        ...
        for fold, (train_idx, val_idx, test_idx) in enumerate(cv_progress):
            ...
            model = ModernNetwork(num_classes=10).to(self.device)
    ...
    def _get_training_components(self, model, steps_per_epoch):
        ...
        optimizer = torch.optim.AdamW(
            model.parameters(),
            lr=0.0001,  # Reduced initial learning rate
        ...
        scheduler = torch.optim.lr_scheduler.OneCycleLR(
            optimizer,
            max_lr=0.001,  # Reduced maximum learning rate
            epochs=100,
    ...
    def _train_epoch(self, model, loader, optimizer, criterion, scheduler, scaler):
        ...
        for batch_idx, (inputs, targets) in enumerate(loader):
            ...
            # Reduce mixup alpha for more stable training
