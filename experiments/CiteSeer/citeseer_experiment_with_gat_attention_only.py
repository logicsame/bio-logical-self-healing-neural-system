...
def create_results_directory():
    results_dir = 'citeseer_results_with_gat_attention'
...
class GraphBioNetwork(nn.Module):
    def __init__(self, num_node_features, num_classes=7, enable_monitoring=False, disable_monitoring=False, results_dir = 'citeseer_results_with_gat_attention'):
        super().__init__()
